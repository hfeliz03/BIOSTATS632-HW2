...
# Specify the path to the Rd file
rd_path <- "MyPackage/man/plot_cp.Rd"

# Check if the file exists
if (file.exists(rd_path)) {
    # Convert directly to Markdown
    markdown_output <- as_markdown(rd_path)

    # Write to an output file
    writeLines(markdown_output, "plot_cp.md")
} else {
    stop("The Rd file does not exist: ", rd_path)
}

as_markdown("MyPackage/man/plot_cp.Rd")
```
